...
<body>
    ...
    <main>
        <div class="boxContainer_order_step1_add">
            ...
            <form action="app-user-order-child-order-step1" method="#" target="#" >
                <div class="care_select_cont">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select id="select_day"class="form-select" required>
                        </select>
                    </div>
                    <div class="input-group mb-3 ">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="tel" aria-label="tel" class="form-control">
                    </div>
                    <div class="input-group mb-3">
