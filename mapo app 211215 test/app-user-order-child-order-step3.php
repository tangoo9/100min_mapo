...
<body>
    ...
    <main>
        <div class="boxContainer_order_step3">
            ...
            <div class="selectBox">
                <button class="selectButton btn_div1" type="button" onclick="location.href='app-user-order-child-order-step2.html'">
                    <p>이전</p>
                </button>
                <button class="selectButton btn_div2" type="button" onclick="location.href='app-user-order-child-order-step4.html'">
                    <p>다음</p>
                </button>
            </div>
        </div>
