...
<body>
    <div id="container">
        <header>
            <button class="returnButton_cont" type ="button" onclick="location.href='app-user-info-list'">
        ...
        <main>
            ...
            <div class="app-user-info-detail-change">
                <div class="layer_popup_cont">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">변경 항목</li>
                        <li class="list-group-item">변경 항목</li>
                        <li class="list-group-item">변경 항목</li>
                        <li class="list-group-item">변경 항목</li>
                        <li class="list-group-item">변경 항목</li>
                      ...
                      <div class="selectBox">
                        <button type="button" class="btn btn-primary btn-sm change" >변경하기</button>
            ...
            <div class="app-user-info-detail-cancel">
                <div class="layer_popup_cont">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="1">필요가 없어요</option>
                        <option value="2">실수로 예약했어요</option>
                        <option value="3">갑자기 아파요</option>
                        <option value="4">날씨가 안 좋아서요</option>
                        <option value="5">운영정책이 마음에 들지 않아요</option>
                        <option value="6">서비스 품질이 마음에 들지 않아요</option>
                        <option value="7">가격이 맞지 않아요</option>
