...
<body>
    <div class="title_area">
        ...
        <h1>돌봄이음</h1>
        <!-- <div class="header_backgorund">
            <img class="main_background" src="image/main_back.png">
        </div> -->
    </div>
    <main>
        <div class="title">
        ...
        <div id="boxContainer">
            <div class="box" >
                <p>아동돌봄</p>
                <p class="order_btn" onclick="location.href='app-user-order-child-order-step1'">
                    돌봄 신청하기
                </p>
            </div>
            <div class="box" >
                <p>성인돌봄</p>
                <p class="order_btn" onclick="location.href=''">
                    돌봄 신청하기
                </p>
            </div>
            <a href ="tel:023035283">
                <div class="box ask">
                    <p>문의하기</p>
                    <p class="info_text">마포형 커뮤니티케어일자리플랫폼 '돌봄이음'</p>
                    <p class="info_text">Tel .  02-303-5283 (월~금 09:00~18:00 / 주말 및 공휴일 휴무</p>
                    <p class="info_text">E-mail .  mapocareu@naver.com</p>
                </div>
            </a>
            <!-- <div class="selectBox">
                <button class="selectButton" type="button" onclick="location.href='app-user-main'"><p>홈으로 이동</p></button>
            </div> -->
        </div>
    </main>
    <footer>
