...
<body>
    <div id="container">
        <main>
            ...
            <div class="boxContainer_order_exec_complete">
                <p>주문번호</p>
                <input type="text" value="20211223_001" disabled>
                <p>서비스명</p>
                <input type="text" value="시간제 돌봄" disabled>
                <p>상세서비스</p>
                <input type="text" value="시간제 돌봄?" disabled>
                <p>예약일자</p>
                <input type="text" value="2022.01.04" disabled>
                <p>예약시간</p>
                ...
                <div class="selectBox">
                    <button class="selectButton" type="button"><p>홈으로 이동</p></button>
                </div>
            </div>
        </main>
        <footer>
