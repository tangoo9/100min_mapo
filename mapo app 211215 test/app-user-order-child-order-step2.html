...
<body>
    ...
    <main>
        <div class="boxContainer_order_step2">
            ...
            <form action="app-user-order-child-order-step3-2" method="#" target="" >
                <div class="care_select_cont">
                    <div class="care_selectBtn" onclick="select('cycle_care')">
                        <div class="sub_title">
                            <p>정기 돌봄</p>
                        </div>
                        ...
                        <div class="care_selectBtn" onclick="select('time_care')">
                            <div class="sub_title">
                                <p>시간제 돌봄</p>
                            </div>
                        ...
                        <input type="hidden" id="care_type" name ="care_type">
                </div>
                ...
                <div class="selectBox">
                    ...
                    <button class="selectButton btn_div2" type="submit" onclick="location.href='app-user-order-child-order-step3-2'">
                        <p>다음</p>
