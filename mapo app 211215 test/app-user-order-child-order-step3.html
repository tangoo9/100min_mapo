...
<body>
    ...
    <main>
        <div class="boxContainer_order_step3 ">
            <div class="title">
                <h2>돌봄이 필요한 요일과<br>시간을 알려주세요.</h2>
                <p>*동원은 최소2시간, 하원은 최소 3시간 이상부터 가능해요.</p>
            </div>
            <div class="care_date_container">
                <div class="care_date text_line">
                    돌봄날짜 
                    <label>
                        <input class="datepicker" type="text" placeholder="날짜를 선택하세요." id="datepicker" >
                        <input type="hidden"  >
                ...
                <div class="care_time">
                    ...
                    <div class="time_container">
                        <input id="timepicker" class="timepicker" name="timepicker" onclick="javascript:fn_timePicker(this);" />
                        ~
                        <input id="timepicker2" class="timepicker" name="timepicker2" onclick="javascript:fn_timePicker(this);" />
                    </div>
                </div>
                <div class="care_time text_line">
                    <span>놀이돌봄만</span>
                    <div class="time_container">
                        <input id="timepicker3" class="timepicker" name="timepicker3" onclick="javascript:fn_timePicker(this);" />
                        ~
                        <input id="timepicker4" class="timepicker" name="timepicker4" onclick="javascript:fn_timePicker(this);" />
                    </div>
                </div>
            </div>
            ...
            <div class="selectBox">
                <button class="selectButton btn_div1" type="button" onclick="location.href='app-user-order-child-order-step2'">
                    <p>이전</p>
                </button>
