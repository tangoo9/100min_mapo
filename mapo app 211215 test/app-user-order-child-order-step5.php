    ...
    <main>
        <div class="boxContainer_order_step5">
            ...
            <form action="#" method="#">
                <div class="care_select_cont">
                    <div class="select_div">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="snack" id="yes" value="yes">
                            <label class="form-check-label" for="yes">
                                신청
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="snack" id="no" value="no"checked>
                    ...
                    <p></p>
                    <textarea placeholder="원하시는 요일과 요청사항이 있으시면 말씀해주세요.(알레르기 정보 등)"></textarea>
                </div>
                ...
                <div class="selectBox">
                    <button class="selectButton btn_div1" type="button" onclick="location.href='app-user-order-child-order-step4'">
                        <p>이전</p>
                    </button>
                    <button class="selectButton btn_div2" type="button" onclick="location.href='app-user-order-child-accept'">
                        <p>다음</p>
                    </button>
                </div>
            </form>
