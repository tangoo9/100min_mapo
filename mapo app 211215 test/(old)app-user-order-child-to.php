        ...
        <main>
            ...
            <div id="boxContainer_child">
                <div class="boxContainer_order-child-to">
                    ...
                    <div class="selectBox">
                        <button class="selectButton btnDiv2" type="button" onclick="location.href='app-user-order-child-list-nouse'">
                            <p>이전</p>
                        </button>
                        <button class="selectButton btnDiv2" type="button" onclick="location.href='app-user-order-child-order'">
                            <p>다음</p>
                        </button>
                    </div>
                </div>
