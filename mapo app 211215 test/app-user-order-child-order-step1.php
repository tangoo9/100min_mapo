...
<body>
        ...
        <div class="boxContainer_order_step1">
            ...
            <form>
                <div class="care_select_cont">
                    ...
                    <div class="add_child" >
                        <!-- onclick="location.href='app-user-order-child-order-step1-add.html'" -->
                        + 아이 추가하기(추후삭제)
                    </div>
                ...
                <div class="selectBox">
                    ...
                    <button class="selectButton btn_div2" type="button" onclick="location.href='app-user-order-child-order-step2'">
                        <p>다음</p>
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        function showList() {
        // let list = "<ul class='care_selectBtn'>";
        ...
        //                 dataList[i].name + 
        //             "</span>" +
        //             "<div><span class='icon delete' data-feather='trash-2'></span></div>" +
        //             "</li>" +
        //             "<li class='text_row'>" +
        //             "<span>"+
        //                 dataList[i].birth + " / " +  dataList[i].sex+
        //             "</span>" +
        //             "<div><span class='icon edit' data-feather='edit' ></span></div>" +
        //             "</li>" + 
        //             "";
        //     }
        //     list +="</ul>";
