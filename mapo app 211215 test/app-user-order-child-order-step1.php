    ...
    <main>
        <div class="boxContainer_order_step1">
            ...
            <div class="care_select_cont">
                <div class="care_selectBtn on">
                    <span class="textBold">정기 돌봄</span>
                    <span>매달 정해진 요일에 선생님이 돌봐주세요</span>
                </div>
                <div class="care_selectBtn">
                    <span class="textBold">비정기 돌봄</span>
                    <span>단기로 정해진 날에 선생님이 돌봐주세요</span>
                </div>
            </div>
            ...
            <div class="selectBox">
                <button class="selectButton btnDiv1" type="button" onclick="location.href='app-user-order-child-order-step2.html'">
                    <p>다음</p>
                </button>
            </div>
        </div>
