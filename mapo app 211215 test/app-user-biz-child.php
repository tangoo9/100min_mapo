...
<body>
            ...
            <div class="info">
                ...
                <hr class="pretty_line" contenteditable="false">
                    <div class="image_info2">
                        <img src="image/child_care_info2.PNG">
                    </div>
                <p>이용요금</p>
                <hr class="pretty_line" contenteditable="false">
                <span>돌봄은 시간당 1,500원이며, 간식은 1회 3,000원 입니다. 
                </span>
                <p>공간안내</p>
                <hr class="pretty_line" contenteditable="false">
                <ul class="footer">
    ...
    <footer>
        <nav id ="navBar">
            <div class="navButton" onclick="location.href='app-user-main.html'">
            ...
            <div class="navButton" onclick="location.href='app-user-biz.html'">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 19H13V13H19V19ZM11 19H5V13H11V19ZM19 11H13V5H19V11ZM11 11H5V5H11V11Z" fill="#2E3A59"/>
                </svg>
                <span>사업소개</span>    
            </div>
            <div class="navButton" class="box" onclick="location.href='app-user-order.html'">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="navButton" class="box" onclick="location.href='app-user-info.html'">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
