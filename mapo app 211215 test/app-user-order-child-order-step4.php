        ...
        <div class="boxContainer_order_step4">
            ...
            <form action="#" method="#">
                <div class="care_select_cont">
                    <div class="row">
                        <div class="care_selectBtn" onclick="select(1)">
                            마포자람
                        </div>
                    </div>
                    <div class="row">
                        <div class="care_selectBtn" onclick="select(2)">
                            마포 유치원
                        </div>
                    </div>
                </div>
                ...
                <div class="selectBox">
                    ...
                    <button class="selectButton btn_div2" type="button" onclick="location.href='app-user-order-child-order-step5'">
                        <p>다음</p>
                    </button>
                </div>
            </form>
