        ...
        <main>
            <div id="boxContainer_child_accept">
                ...
                <div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td class="agree_contents">
                                    ...
                                    <br>
                                    수집·이용 목적 : 마포커뮤니티케어 서비스 이용 신청에 따른 본인 확인 및 이용 관리
                                    <br>
                                    보유기간 : 서비스 이용 종결시까지
                                </td>
                            </tr>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td class="agree_contents">
                                    ...
                                    <br>
                                    사용 목적: 마포커뮤니티케어 사업 홍보매체 및 인쇄물(브로셔, 소식지, 홈페이지 게시물 등), 언론매체(신문, 잡지 기사 등) 등 사업 홍보
                                    <br>
                                    사용 형태: 마포커뮤니티케어 사업 서비스 참여시 촬영된 사진 및 동영상 자료
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="selectBox">
                        <button class="selectButton" type="button" onclick="location.href='app-user-order-child'">
                            <p>신청하기</p>
                        </button>
                        <button class="selectButton" type="button" onclick="location.href='app-user-order-child-order-step1'">
                            <p>임시페이지 이동</p>
                        </button>
                    </div>
            </div>
