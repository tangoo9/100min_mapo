        ...
        <main>
            ...
            <div id="boxContainer_child">
                <div class="boxContainer_order-child-order">
                    ...
                    <div class="selectBox">
                        <button class="selectButton btnDiv2" type="button" onclick="location.href='app-user-order-child-to'">
                            <p>이전</p>
                        </button>
                        <!-- <button class="selectButton btnDiv2" type="button" onclick="location.href='app-user-order-child-order-complete'"> -->
                        <button class="selectButton btnDiv2" type="button" onclick="location.href='app-user-order-child-order-step1'">
                            <p>신청</p>
                        </button>
                    </div>
                </div>
