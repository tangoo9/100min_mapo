...
session_chk();
$search = ($_GET[p_name] != "")?"where p_name = '{$_GET[p_name]}' and p_biz_check = '업체'":"where p_biz_check='업체'";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/bootstrap.min.css?7357">
	<link rel="stylesheet" type="text/css" href="style.css?6134">
	<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,800,300&display=swap&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
    <title>admin-manager-1</title>
		...
		<div class="row">
			<div class="col-12">
				<div class="row row-style">
					...
					<div class="col-lg-2">
						<a href="admin-service-register" class="btn btn-d btn-lg btn-padding k-margin-main k-m-l-10">업체 등록</a>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="bloc l-bloc none">
                <div class="container bloc-lg-table ">
                    <div class="row">
                        <div class="col-12 col-lg-1">
                            <label class="form-label label-style text-lg-start">
                                <?=$r[$i][p_biz_service]?><br>
                            </label>
                        </div>
                        <div class="col-12 col-lg-2">
                            <label class="form-label text-lg-end">
                                <?=$r[$i][p_biz_service_detail]?><br>
                            </label>
                        </div>
                        <div class="col-12 col-lg-2">
                            <label class="form-label text-lg-center">
                        ...
                        <div class="col-12 col-lg-1">
                            <a href="admin-service-assign?p_no=<?=$r[$i][p_no]?>" class="btn btn-d btn-button-padding btn-lg k-t-s-s">수정<br></a>
                        </div>
                    </div>
