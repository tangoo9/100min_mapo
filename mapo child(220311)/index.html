...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/bootstrap.min.css?1267">
	<link rel="stylesheet" type="text/css" href="style.css?3763">
			...
			<div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-4 offset-lg-4 auto">
				<form id="form_1" method="POST" action="login">
					<div class="form-group mb-3">
						...
						<input id="id" name="a_id" class="form-control" required maxlength="50" data-validation-required-message="아이디를 입력해 주세요." />
					</div>
					<div class="form-group mb-3">
						<label class="form-label">
							패스워드
						</label>
						<input id="passwd" name="a_pw" class="form-control" type="password" required data-validation-required-message="패스워드를 입력해 주세요." maxlength="50" />
...
<script src="./js/formHandler.js?1644"></script>
