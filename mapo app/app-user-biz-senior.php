...
<body>
    ...
    <main>
        <div class="biz_adultcare_container">
            <div class="title">
                <p>성인돌봄</p>
            </div>
            <div class="info">
                <span>돌봄 사각지대에 있는 어르신이 건강한 노년생활을 영위할 수 있도록 
                    전문돌봄매니저가 가정을 방문하여 
                사례진단, 서비스 계획수립 및 정기적인 돌봄서비스 제공합니다. 
                </span>
                <p>이용대상</p>
                <hr class="pretty_line_blue" contenteditable="false">
                <span>마포구 관내 거주하며 돌봄서비스가 필요한 만65세 이상 어르신</span>
                <span>※ 만65세 이하 중장년층이나 거동불편, 경제적 어려움으로 사적돌봄서비스 이용이 어려운 경우, 
                    기타 돌봄 필요 사유가 있을 경우 사례회의를 통해 대상자로 선정될 수 있습니다. </span>
                <p>이용방법</p>
                <hr class="pretty_line_blue" contenteditable="false">
                <span>마포구 관내 거주하며 돌봄서비스가 필요한 어르신으로
                    동주민센터 및 타 돌봄기관을 통해 서비스 의뢰를 받으신 분
                </span>
                <p>돌봄서비스 제공과정</p>
                <hr class="pretty_line_blue" contenteditable="false">
                <div class="image_info">
                    <img src="image/adult_care_info.PNG">
                </div>
                <p>돌봄서비스 구성</p>
                <hr class="pretty_line_blue" contenteditable="false">
                <div class="image_info2">
                    <img src="image/adult_care_info2_1.png" alt="홈케어주택수리" onclick="window.open('about:blank').location.href='app-user-blog?url=https://m.blog.naver.com/mapojaram/222685264027'">
                    <img src="image/adult_care_info2_2.png" alt="일상생활편의" onclick="window.open('about:blank').location.href='app-user-blog?url=https://m.blog.naver.com/mapojaram/222685264741'">
                    <img src="image/adult_care_info2_3.png" alt="정서.여가.건강서비스" onclick="window.open('about:blank').location.href='app-user-blog?url=https://m.blog.naver.com/mapojaram/222685265305'">
                </div>
                <p>이용요금</p>
                <hr class="pretty_line_blue" contenteditable="false">
                <span>동주민센터 및 타 돌봄기관의 의뢰로 대상자에 선정되신 분은 무료로 제공되며,
                    사례종결  이후에도 일부 서비스 이용을 희망하실 경우 별도 자부담 비용이 발생합니다. 
                </span>
                ...
                <ul class="footer">
                    <li>
                        <p>마포형 커뮤니티케어 일자리 플랫폼 | 돌봄이음</p>
                        <ul class="list">
                            <li> 마포구 매봉산로18 1,2층 마포구고용복지지원센터</li>
                            <li>Tel. 070-4163-3631   </li>
                            <li> E-mail. mapocareu@naver.com</li>
                            <li>운영시간. 월~금 09:00~18:00 (주말 및 공휴일 휴무)</li>
                        </ul>
                    </li>
                </ul>
                <!-- <span>마포커뮤니티케어사업단 ㅣ  마포구 매봉산로18 1,2층 마포구고용복지지원센터
                    Tel .  02-303-5283                     E-mail .  mapocareu@naver.com
