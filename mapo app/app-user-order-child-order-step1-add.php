...
<body>
    ...
    <main>
        <div class="boxContainer_order_step1_add">
            <div class="title">
                <h2>아이정보를<br>입력해주세요</h2>
                <p>(*)필수입력 사항입니다.</h2>
            </div>
            <form action="/api/app_child" method="post">
                <input type="hidden" name="method" value="register">
                <div class="care_select_cont">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">이름<small>*</small></span>
                        <input type="text" id="name" name="name" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" autocomplete="off" required>
                        <div class="check_font" id="name_check"></div>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">생년월일<small>*</small></span>
                        <select id="year" name="select_year" class="form-select" required onchange="javascript:lastday();">
                        </select>
                        <select id="month" name="select_month" class="form-select" required onchange="javascript:lastday();">
                        </select>
                        <select id="day" name="select_day" class="form-select" required>
                        </select>
                    </div>
                    <div class="input-group mb-3 ">
                        <span class="input-group-text" id="inputGroup-sizing-default">성별<small>*</small></span>
                        <div class="select_text">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sex" value="여" required>
                                <label class="form-check-label" for="woman">
                                    여자
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sex" value="남">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">아동 연락처</span>
                        <input type="tel" id="phone" name="tel" aria-label="tel" autocomplete="off" class="form-control" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" maxlength="13">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">학교</span>
                        <input type="text" id="school" name="school" autocomplete="off" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">학년</span>
                        <select name="grade" class="form-select" aria-label="Default select example" required>
                            <option selected disabled>학년을 선택하세요.</option>
                            <option value="예비초등학생">예비초등학생</option>
                ...
                <div class="selectBox">
                    ...
                    <button id="submitBtn" class="selectButton btn_div2" type="submit" onclick="return check()">
                        <p>확인</p>
                    </button>
                </div>
            </form>
