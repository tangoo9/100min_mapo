...
where o.m_no = '{$_SESSION[m_no]}' and (o_status = '취소' or o_status = '제공완료')";
$r = sqlresult($o);
$rr = sqlrow($o);
?>
<!DOCTYPE html>
        ...
        <div id="boxContainer">
            <div class="listContainer">
                <div class="listMenu">
                    ...
                    <div class="listMenu_button">
                        <p onclick="location.href='app-user-info-list-cancel'" style="font-size: 1.3em;text-decoration: underline;">완료 및 취소 내역</p>
                    </div>
                </div>
                <table class="list">
                    <thead>
