...
<body>
                            ...
                            <div class="care_date_container">
                                ...
                                <section class="calendar_container">
                                    <div class="date_wrapper">
                                        <div class="guide_text">
                                            <p>비고</p>
                                            <input type="text" value="<?=$o[o_comment]?>" id=""  name="o_comment" inputmode="none" autocomplete="off">
                                        </div>
                                    </div>
                                <section>
                            </div>
    ...
    window.onload = function(){
        console.log("onload 확인")
            $("input[name='mon_day']").load(function(){
