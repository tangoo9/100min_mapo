...
<body>
    ...
    <main>
        <div class="boxContainer_order_step3_1">
            ...
            <form action="app-user-order-normal-order-complete" method="POST">
                <div class="care_date_container">
                    <div class="input-group mb-3">
                        <span class="input-group-text">
                            날짜<small>*</small>
                        </span>
                        <input type="text" name="order_date" id="datepicker" value="" class="form-control datetpicker" autocomplete="off" required/>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">
                            시간<small>*</small>
                        </span>
                        <input type="text" name="order_time" id="timepicker" value="" class="form-control timepicker" autocomplete="off" required/>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="order_cmt" class="form-control">
                    </div>
                </div>
