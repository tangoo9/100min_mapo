...
where o.m_no = '{$_SESSION[m_no]}' and o_status != '취소' and o_status != '제공완료'";
$r = sqlresult($o);
$rr = sqlrow($o);
?>
<!DOCTYPE html>
            ...
            <div class="listContainer">
                <div class="listMenu">
                    <div class="listMenu_button">
                        <p onclick="location.href='app-user-info-list'" style="font-size: 1.3em;text-decoration: underline;">진행예정</p>
                    </div>
                    <div class="listMenu_button">
