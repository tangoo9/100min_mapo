...
<body>
    ...
    <main>
        <div class="boxContainer_order_step1">
            ...
            <form action="app-user-order-child-order-step2" method="#" onsubmit="return check()">
                <div class="care_select_cont">
                    <!-- <ul class="care_selectBtn">
                        <input type="hidden" id="select_this" name="select_this" value="">
                        <div class="row">
                            <li class="text_row">
    ...
    <script>
        ...
        function showList() {
            ...
            for(let i = 0; i < dataList.length ; i ++){
                list += 
                "<ul class='care_selectBtn'>"+
                    "<input type='hidden' id='select_"+(i+1)+"' name='select_"+(i+1)+"' value='"+dataList[i].no+"'>" +
                    "<div class='row'>" +
                        "<li class='text_row'>" +
                            "<span class='textBold'>"+
                                dataList[i].name + 
        ...
        function add_list(){    
            ...
            if(check == ""){
                ...
                this.style.backgroundColor = '#ffeed4';
