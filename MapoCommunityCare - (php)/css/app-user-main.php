...
<head>
    ...
    <link rel="stylesheet" href="css/app-user-main.css">
    <link rel="stylesheet" href="css/app-user-footer.css">
</head>
<body>
    <div class="title">
        <h1>
            <span class="title_1">마포</span>
            <span class="title_2">커뮤니티</span>
            <span class="title_3">케어</span>
        </h1>
    </div>
    <main>
        <div class="menu_container">
            <div class="boxRow">
                <div class="box" onclick="location.href='app-user-biz'">
                    <img src="image/biz_pre001.png">
                    <p>사업소개</p>
                </div>
                <div class="box" onclick="location.href='app-user-order'">
                    <img src="image/biz_pre003.png">
                    <p> 돌봄 신청</p>
                </div>
            </div>
            <div class="boxRow">
                <div class="box" onclick="location.href='app-user-info-list'">
                    <img src="image/biz_pre002.png">
                    <p>돌봄내역</p>
                </div>
                <div class="box" onclick="location.href='app-user-info'">
                    <img src="image/biz_pre004.png">
                    <p>내정보</p>
                </div>
            </div>
        </div>
