...
<body>
    ...
    <main class="mainContainer">
        ...
        <div id="boxContainer_polices">
            <div class="subContainer">
                <span class="textTitle">서비스 약관</span>
                <div class="textBox_polices">
                    <p>
                        성인돌봄(커뮤니티케어)
                    </p>
                    1) 돌봄대상자 나이제한이 있나요?
                    => 기본적으로 65세 이상의 어르신께 서비스를 제공하고 있으나, 65세 이하의 중/장년층에
                    해당하며 거동이 크게 불편하시거나, 재정적인 어려움이 커 사적 돌봄 서비스를 받기 어려우신경우,
                    기타 돌봄이 필요한 사유에 충족 될 경우 회의를 통해 대상자로 선정될 수 있습니다.
                    <br>
                    2) 돌봄대상자 나이제한이 있나요?
                    => 기본적으로 65세 이상의 어르신께 서비스를 제공하고 있으나, 65세 이하의 중/장년층에
                    해당하며 거동이 크게 불편하시거나, 재정적인 어려움이 커 사적 돌봄 서비스를 받기 어려우신경우,
            ...
            <div class="subContainer">
                <span class="textTitle">개인정보 이용약관</span>
                <div class="textBox_polices">
                    <p>
                        성인돌봄(커뮤니티케어)
                    </p>
