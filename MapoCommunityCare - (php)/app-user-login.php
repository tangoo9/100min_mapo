...
<body>
    <main>
        ...
        <div class="loginContainer">
            <form class="form" action="app-user-main" method="get">
                <div class="input_box id_box"> 
                    ...
                    <input name="m_id" class="input" type="text" placeholder="이메일을 입력해 주세요.">
                </div>
                <div class="input_box pw_box">
                    ...
                    <input name="m_pw" class="input" type="password" placeholder="패스워드를 입력해 주세요.">
                </div>
            ...
            <button class="button loginButton_kakao" type="button">카카오톡 로그인</button>
