...
left join member_child mc on mc.m_no = o.mc_no
{$search}  group by o_no order by o_order_date asc";
$r = sqlresult($sql);
$rr = sqlrow($sql);
?>
<!doctype html>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/bootstrap.min.css?137">
	<link rel="stylesheet" type="text/css" href="style.css?2518">
